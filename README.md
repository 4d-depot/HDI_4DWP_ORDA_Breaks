# HDI_4DWP_ORDA_Breaks 

Use break rows in [4D Write Pro ](https://us.4d.com/4D-write-pro) tables (4D v20) 

Find more information on the [blog post](https://blog.4d.com/break-rows-a-new-addition-to-4d-write-pro-tables/).
